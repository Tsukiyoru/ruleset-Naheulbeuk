...
function getTopWindow(w)
	local wTop = w;
	while wTop and ((wTop.windowlist and wTop.windowlist.window) or (wTop.parentcontrol and wTop.parentcontrol.window)) do
...
function getRootNodeName(vNode)
	...
	if nodeResult then return nodeResult.getName(); end
	return "";
end
