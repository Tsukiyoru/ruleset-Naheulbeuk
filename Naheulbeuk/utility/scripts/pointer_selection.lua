...
function onInit()
	...
	registerTrigger(10, 15, "red", STEP_BIG);
	registerTrigger(17, 12, "red", STEP_MED);
	registerTrigger(23, 8, "red", STEP_SML);
	
	registerTrigger(64, 15, "green", STEP_BIG);
	registerTrigger(71, 12, "green", STEP_MED);
	registerTrigger(77, 8, "green", STEP_SML);

	registerTrigger(87, 15, "blue", STEP_BIG);
	registerTrigger(94, 12, "blue", STEP_MED);
	registerTrigger(00, 8, "blue", STEP_SML);

	registerTrigger(44, 15, "black", STEP_BW);
	registerTrigger(53, 15, "white", STEP_BW);

	registerTrigger(33, 15, "text", STEP_BW);
...
function adjustColor(method, amount)
	if method == "red" then
...
function onClickDown(button, x, y)
	local rTrigger = getTrigger(x, y);
	if rTrigger then
		adjustColor(rTrigger.method, rTrigger.amount);
	end
	return true;
end
...
function onWheel(notches, x, y)
	local rTrigger = getTrigger(x, y);
	if rTrigger then
		adjustColor(rTrigger.method, STEP_WHEEL*notches);
	end
	return true;
end
